...
public class PuzzleJava {
    public static void main(String[] args) {
        ...
        //Create an array that contains all 26 letters of the alphabet (this array must have 
        ...
        //Generate and return an array with 10 random numbers between 55-100 and have it be 
        //sorted (showing the smallest number in the beginning). Display all the numbers in the 
